package com.mobile.pos.iago.taskmanager.services;
...
public class ChatHeadService extends Service {
    ...
    private void handleStart() {
        ...
        removeView = (RelativeLayout) inflater.inflate(R.layout.remove_chat_head_service, null);
    ...
    private void chathead_click() {
        if (MainActivity.isActive) {
            ...
            // Intent it = new Intent(this, DeckView.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (bd != null)
                sMsg = bd.getString("Message starting..");
